...
class EncoderGenB(nn.Module):
    def __init__(self):
        super(EncoderGenB, self).__init__()
        n_ch_in = 1
...
class DecoderGenB(nn.Module):
    def __init__(self) :
        super(DecoderGenB, self).__init__()
        n_ch_out=1
