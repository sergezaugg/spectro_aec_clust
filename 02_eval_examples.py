...
path_enc = 'encoder_model_20250506_194638_epo_40.pth' 
path_dec = 'decoder_model_20250506_194638_epo_40.pth'
...
# plot 
for ii in range(n_images) : # np.random.randint(data.shape[0], size = n_images):
