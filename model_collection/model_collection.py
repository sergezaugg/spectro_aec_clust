...
# -------------------------------------------------
# GEN B-1 (freq-pool : 128 - time-pool : 64)

class EncoderGenBTP64(nn.Module):
    def __init__(self, n_ch_in = 3, ch = [64, 128, 128, 128, 256]):
        super(EncoderGenBTP64, self).__init__()
        po = [(2, 2), (4, 2), (4, 4), (2, 2), (2, 2)]
        self.padding =  "same"
...
class DecoderGenBTP64(nn.Module):
    def __init__(self, n_ch_out=3, ch = [256, 128, 128, 128, 64]):
        super(DecoderGenBTP64, self).__init__()
        po =  [(2, 2), (2, 2), (4, 4), (4, 2), (2, 2)]
